...
class Pantalla:
    ...
    def __init__(self,height,width):
        ...
        self.character_sprite_url = os.getcwd().replace('\\','/') + '/main_sprites/'
    ...
    def evaluar_saltar(self):
        ...
        if(self.salto):
            ...
            if(self.salto>self.max_salto//2):
                self.set_character_position(self.character_position[0]-self.velocidad_salto,self.character_position[1])
            else:
                self.set_character_position(self.character_position[0]+self.velocidad_salto,self.character_position[1])
            self.salto -= 1
    ...
    def add_obstacle(self):
        ...
        #self.lista_obstaculos.append([self.obstacle_heigth,self.width])
